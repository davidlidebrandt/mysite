...
export default function Teach() {
  return (
    <div className="grid grid-cols-12 text-center text-xl font-bold">
      ...
      <div className="col-span-12 md:col-span-6 md:col-start-4 w-full  xl:col-span-4 xl:w-3/4 bg-white mt-36 m-auto transform -rotate-3 rounded relative min-height-600 transform hover:scale-105 hover:rotate-0 transition-all duration-700 shadow-2xl">
      ...
      <div className="col-span-12 md:col-span-6 md:col-start-4 w-full  xl:col-span-4 xl:w-3/4 bg-white mt-36 m-auto rounded relative min-height-600 transform hover:scale-105 hover:rotate-0 transition-all duration-700 shadow-2xl">
      ...
      <div className="col-span-12 md:col-span-6 md:col-start-4 w-full  xl:col-span-4 xl:w-3/4 bg-white my-36 m-auto transform rotate-3 min-height-600 rounded relative transform hover:scale-105 hover:rotate-0 transition-all duration-700 shadow-2xl">
