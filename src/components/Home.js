    ...
    return (
        <div className="grid grid-cols-3 text-center text-xl font-bold">
           ...
           <div className="w-2/3 bg-white my-36 m-auto transform -rotate-3 py-4 rounded min-height-500 transform hover:scale-105 hover:rotate-0 transition-all duration-700 shadow-2xl">
               ...
               <Link to="/aboutme" className="inline-block border-4 border-yellow-200 bg-yellow-200 rounded-lg py-4 px-8 font-bold hover:bg-white hover:border-yellow-200 hover:text-yellow-200 shadow-xl">Read More</Link>
            </div> 
           <div className="w-2/3 bg-white my-36 m-auto py-4 rounded min-height-500 transform hover:scale-105 hover:rotate-0 transition-all duration-700 shadow-2xl">
                ...
                <Link to="/techstack" className="inline-block border-4 border-green-100 bg-green-100 rounded-lg py-4 px-8 font-bold hover:bg-white hover:border-green-100 hover:text-green-100 shadow-xl">Read More</Link>
            </div> 
           <div className="w-2/3 bg-white my-36 m-auto transform rotate-3 py-4 rounded min-height-500 transform hover:scale-105 hover:rotate-0 transition-all duration-700 shadow-2xl">
                <h4 className="text-2xl font-extrabold">Projects</h4>
                <Link to="/projects" className="inline-block border-4 border-green-200 bg-green-200 rounded-lg py-4 px-8 font-bold hover:bg-white hover:border-green-200 hover:text-green-200 shadow-xl">Read More</Link>
            </div> 
            <div className="message-div col-start-2 mb-20 bg-white min-height-700 rounded" style={{clipPath: "polygon(0 0, 100% 0%, 100% 75%, 75% 75%, 75% 100%, 50% 75%, 0% 75%)"}}>
            <div className="message-div col-start-2 mb-36 bg-white  min-height-500 transform scale-90 rounded py-4 shadow-xl box-border" >
                <h4 className="text-3xl font-extrabold mb-3">Want to get in touch?</h4>
                ...
                <form>
                    <div className="my-3 mx-4">
                        ...
                        <input className="block m-auto w-full rounded  border-2 border-gray-200 focus:ring-2 focus:ring-yellow-200 focus:outline-none" type="email" required></input>
                    </div>
                    <div className="my-3 mx-4">
                    ...
                    <button className="inline-block my-4 border-4 border-green-200 bg-green-200 rounded-lg py-3 px-6 font-bold hover:bg-white hover:border-green-200 hover:text-green-200 shadow-xl">Send</button>
